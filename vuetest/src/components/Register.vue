...
<body>
    <form>
        <div class="wrapper">
            ...
            <br>
            <div class="input-data">
                <input type="password" id="check" v-model="checkPassword" required autocomplete="off">
                <div class="underline"></div>
                <label for="email">再次输入密码</label>
            </div>
            <input type="submit" value="注册" id="submit" name="submit" @click.prevent="register">
        </div>
    </form>
</body>
...
<script>
    ...
    export default {
        ...
        methods: {
            register(){
                if (this.uName !== "" && this.uPassword !== "" && this.uPassword === this.checkPassword) {
                    ...
                    if (this.uPassword !== this.checkPassword) {
